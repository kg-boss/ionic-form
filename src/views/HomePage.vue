...
<script lang="ts">
import { IonContent, IonHeader, IonPage, IonTitle, IonToolbar, IonInput, IonLabel, IonItem, IonList, IonButton, IonSelect, IonCheckbox, IonRadio, IonRadioGroup } from '@ionic/vue';
...
export default defineComponent({
  ...
  methods: {
    ...
    loadSubjectOptions   () {Subject   .all(( subjects  ) => {this.subjects           = subjects   ;});}
  },
  mounted() {
    this.load();
  }
